...
export default {
  ...
  SIMPLE_IMAGE_SECTION: "Simple frontmatter image",
  ENABLE_SIMPLE_IMAGE: "Enable simple frontmatter image",
  SIMPLE_IMAGE_PROPERTY: "Frontmatter image property",
  SIMPLE_IMAGE_POSITION: "Image position",
